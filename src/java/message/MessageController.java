...
import message.util.JsfUtil;
import message.util.PaginationHelper;
import message.MessageFacade;
...
public class MessageController implements Serializable {
    ...
    @EJB
    private message.MessageFacade ejbFacade;
    ...
    public static class MessageControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Message) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MessageController.class.getName());
            }
        }
    }
}
